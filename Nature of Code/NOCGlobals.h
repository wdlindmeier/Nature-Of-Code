...
#ifndef Nature_of_Code_NOCGlobals_h
#define Nature_of_Code_NOCGlobals_h
...
static NSString * __unused NOCTOCKeyCodeURL = @"Code URL";
static NSString * __unused NOCTOCKeyBookURL = @"Book URL";
