//
//  NOCSampleSketchViewController.m
//  Nature of Code
//
...
@implementation NOCSampleSketchViewController
...
- (void)setup
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(kCubeVertexData), kCubeVertexData, GL_STATIC_DRAW);
...
- (void)draw
{
    ...
    glUniformMatrix4fv([mvProjMatLoc intValue], 1, 0, _modelViewProjectionMatrix.m);
    glUniformMatrix3fv([normMatLoc intValue], 1, 0, _normalMatrix.m);
